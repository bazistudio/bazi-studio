    ...
    <div className="min-h-screen pt-1">
          ...
          <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
            <div className="order-2 md:order-1">
              ...
              <h2 className="text-3xl md:text-4xl font-bold mb-6">
                From <span className="linear-text">Passion</span> to Profession
              </h2>
      ...
      {activeTab === 'skills' && (
        <section className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              My <span className="linear-text">Skills</span>
            </h2>
      ...
      {activeTab === 'values' && (
        <section className="max-w-7xl mx-auto px-4 py-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              My <span className="linear-text">Values</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
      ...
      {activeTab === 'journey' && (
        <section className="max-w-4xl mx-auto px-4 py-8">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold mb-6">
              My <span className="linear-text">Journey</span>
            </h2>
            <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
