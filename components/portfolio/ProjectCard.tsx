...
export default function ProjectCard({
  ...
  const variantStyles = {
    ...
    mobile:
      "bg-gradient-to-br from-blue-50 to-purple-50 dark:from-gray-800 dark:to-gray-900 border border-blue-100 dark:border-gray-700",
    featured:
      "bg-gradient-to-br from-orange-50 to-yellow-50 dark:from-gray-800 dark:to-gray-900 border-2 border-orange-200 dark:border-orange-900",
  };
  ...
  return (
    ...
    >
      ...
      <div className="relative h-56 md:h-64 overflow-hidden">
        ...
        <div
          className={`absolute inset-0 bg-gradient-to-t from-black/70 to-transparent flex items-center justify-center transition-all duration-500 ${
